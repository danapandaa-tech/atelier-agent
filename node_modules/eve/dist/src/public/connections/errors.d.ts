 ...
 */
export declare class ConnectionAuthorizationFailedError extends Error {
    readonly connectionName: string;
    readonly reason?: string;
    readonly retryable: boolean;
 ...
 */
export declare function isConnectionAuthorizationRequiredError(err: unknown): err is ConnectionAuthorizationRequiredError;
/**
 ...
 * after bundling (dual-instance hazard in Nitro output).
 */
export declare function isConnectionAuthorizationFailedError(err: unknown): err is ConnectionAuthorizationFailedError;
