...
export type WorkerToMainMessage = WorkerToolRequest | WorkerFetchRequest | WorkerBridgeDrainedMessage | WorkerResultMessage | WorkerReadyMessage;
export type MainToWorkerMessage = WorkerRunMessage | WorkerBridgeResponse | WorkerBridgeDrainRequest;
export {};
