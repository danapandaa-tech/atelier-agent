 ...
 * overrides.
 */
export declare const DEFAULT_SANDBOX_SOURCE_ID = "eve:default-sandbox";
/**
 ...
 * framework default.
 */
export declare function createRuntimeSandboxRegistry(input: {
 ...
 */
export declare function createFrameworkSandboxDefinition(): ResolvedSandboxDefinition;
